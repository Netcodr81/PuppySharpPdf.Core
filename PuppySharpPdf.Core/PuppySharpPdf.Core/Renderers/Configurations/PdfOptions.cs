...
public class PdfOptions
{
    ...
    public PuppeteerSharp.PdfOptions MappedPdfOptions => new PuppeteerSharp.PdfOptions
    {
        ...
        FooterTemplate = !string.IsNullOrEmpty(this.FooterTemplate) ? _htmlUtils.NormalizeHtmlString(this.FooterTemplate) : this.FooterTemplate,
        HeaderTemplate = !string.IsNullOrEmpty(this.HeaderTemplate) ? _hHtmlUtils.NormalizeHtmlString(this.HeaderTemplate) : this.HeaderTemplate,
